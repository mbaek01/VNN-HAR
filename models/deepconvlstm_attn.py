...
class ConvBlock(nn.Module):
    ...
    """
    def __init__(self, filter_width, input_filters, nb_filters, batch_norm):
...
class DeepConvLSTM_ATTN(nn.Module):
    def __init__(self, 
        ...
        for i in range(self.nb_conv_blocks):
            ...
            self.conv_blocks.append(ConvBlock(self.filter_width, input_filters, self.nb_filters, self.batch_norm))
